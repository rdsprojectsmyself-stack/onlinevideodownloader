...
const App = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-[url('/background.png')] bg-cover bg-center">
            <div className="min-h-screen w-full bg-black/60 flex items-center justify-center px-4">
                <AnimatePresence mode="wait">
                    {!user ? (
                        ...
                        >
                            <div className="w-full bg-white/90 backdrop-blur-lg rounded-xl shadow-2xl p-6">
                                ...
                                <button
                                    onClick={handleLogin}
                                    className="w-full bg-black text-white py-2 rounded-md flex items-center justify-center gap-3 transition-all shadow-sm hover:shadow-md hover:bg-gray-800"
                                >
                                    <img
